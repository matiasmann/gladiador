				...
				<nav id="image-navigation" class="navigation image-navigation">
					<div class="nav-links">
						<span class="nav-parent">
							<a href="<?php echo esc_url( get_permalink( $parent ) ); ?>" rev="attachment" class="attachment-parent"><?php esc_html_e( '&lsaquo; Return to post', 'gladiador' ); ?></a>
						</span>
						<span class="nav-previous">
							<?php previous_image_link( false, esc_html__( 'Previous Image', 'gladiador' ) ); ?>
						</span>
						<span class="nav-next">
							<?php next_image_link( false, esc_html__( 'Next Image', 'gladiador' ) ); ?>
						</span>
					</div>
				</nav>
