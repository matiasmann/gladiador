 ...
 * @return boolean
 */
function gladiador_sanitize_checkbox( $setting ) {
 ...
 */
function gladiador_sanitize_categories( $setting ) {
 ...
 * @return integer
 */
function gladiador_sanitize_int( $setting ) {
 ...
 */
function gladiador_sanitize_hex_color( $color ) {
 ...
 * @return string
 */
function gladiador_sanitize_fonts( $id ) {
