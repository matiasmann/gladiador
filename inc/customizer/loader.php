...
require get_parent_theme_file_path( 'inc/customizer/class-gladiador-font-selector.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

// A custom control that adds a link to the docs in the customizer.
require get_parent_theme_file_path( 'inc/customizer/class-gladiador-doc-link.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
