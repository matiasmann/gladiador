 ...
 */
function gladiador_featured_images() {
	 ...
	 */
	add_image_size( 'gladiador-header', 1600, 900, true );

	// Archive & homepage thumbnails.
	add_image_size( 'gladiador-archive', 720, 405, true );

}

add_action( 'after_setup_theme', 'gladiador_featured_images' );
 ...
 */
function gladiador_featured_image_src( $post_id = null, $thumbnail_size = 'gladiador-archive', $attr = array() ) {
