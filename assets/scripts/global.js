...
; ( function() {
	...
	window.gladiador.getParents = getParents;
...
; ( function() {
	...
	window.gladiador.menuToggle = menuToggle;
...
; ( function() {
	...
	var menuTouch = function() {
		...
		events.on(
			...
			function( e ) {
				...
				var $parents = gladiador.getParents( e.target, 'li' );
	...
	window.gladiador.menuTouch = menuTouch;
